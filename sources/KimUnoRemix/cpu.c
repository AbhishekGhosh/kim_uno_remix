...
unsigned char rom003[1024] = {
	...
	0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xCA, /* Arduino tools seem to barf out an error */
	0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFE, /* if there's tons of FFs in a row. */
	0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xBA,
	0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xBE, /* So we'll break this big block up with */
	0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0x00, /* CAFE BABE FEED FACE DEAD COFFEE BEEF */
...
MMAP ROMSegments[6] = {
  ...
  { 0xc000, 1393, mchess }, // 0xA9, 0x00, 0x85, 0xB7, 0x20, 0x54, 0xC4, 0xD8, 0xA2, 0xFF, 0x9A, 0xA2,
  { 0xfffA, 6, rom002 + 0x3fa }, // 1c 1c 22  1c 1f 1c
  { 0, 0, 0 }
};
...
{  // Call this from main() if you want a program preloaded. It's the first program from First Book of KIM...
        ...
        uint8_t fbkDemo[9] = { 0xA5, 0x10, 0xA6, 0x11, 0x85, 0x11, 0x86, 0x10, 0x00 };
        for (i=0;i<9;i++)
