...
/*
   Note: the following chunk may be removed.  It does not seem to be 
         accessed, although I can't be sure of that. And the end of the
         ROM might be referenced somewhere.  This would save 350 bytes.
 */
